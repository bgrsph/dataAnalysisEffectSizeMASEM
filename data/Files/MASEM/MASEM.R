...
vector <- readStackVec ("~/Desktop/repo/dataAnalysisEffectSizeMASEM/data/Files/MASEM/MA_CBTidpcom.txt") #change file for different candidate mediator
vector
...
n <- read.table("~/Desktop/repo/dataAnalysisEffectSizeMASEM/data/Files/MASEM/MA_CBTidpcom_n.txt") #change file for different candidate mediator
n
